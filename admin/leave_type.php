 ...
 if(isset($_POST['add']))
{
     ...
     $query = mysqli_query($conn,"select * from tblleavetype where LeaveType = '$leavetype'")or die(mysqli_error($conn));
     ...
     if ($count > 0){ 
        ...
        $query = mysqli_query($conn,"insert into tblleavetype (LeaveType, Description,date_from,date_to,No_of_days)
  		 values ('$leavetype', '$description' ,'$date_from','$date_to','$No_of_days')      
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input name="No_of_days" type="text" class="form-control" required="true" autocomplete="off">
											</div>
										</div>
									</div>
								...
								<div class="pb-20">
									<table class="data-table table stripe hover nowrap">
										...
										<tr>
											...
											<th class="table-plus">Number of Days Allocated</th>
