	...
	<div class="main-container">
		<div class="pd-ltr-20">
			<div class="title pb-20">
				<h2 class="h3 mb-0">Administrative Summary Report</h2>
			</div>
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">Staff Leave Days Summary Report </h2>
					</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								 <?php
		                         $teacher_query = mysqli_query($conn,"select * from tblemployees  ORDER BY tblemployees.emp_id") or die(mysqli_error());
