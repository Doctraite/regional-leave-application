	...
	<div class="main-container">
		<div class="pd-ltr-20">
			...
			<div class="row pb-10">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">All Available Employees </div>
							</div>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_staff = mysqli_query($conn,"select * from tblemployees where role = 'Staff' ")or die(mysqli_error($conn));
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Staff excluding Admins</div>
							</div>
							<div class="widget-icon">
					...
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Admin Assistant</div>
							</div>
							<div class="widget-icon">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_admin = mysqli_query($conn,"select * from tblemployees where role = 'Admin' ")or die(mysqli_error($conn));
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								...
								<div class="font-14 text-secondary weight-500">Current System Administrators</div>
							</div>
							<div class="widget-icon">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
						<h2 class="text-blue h4">ALL STAFF LIST </h2>
					</div>
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								 ...
								 <?php
		                         $teacher_query = mysqli_query($conn,"select * from tblemployees  ORDER BY tblemployees.emp_id") or die(mysqli_error($conn));
