...
<?php
   ...
   //Calculate Leave days using weekdays & excluding weekends
   /*function getWorkingDays()
   {
	...
	{ 
		...
		$V_leave=$_POST['V_leave_days'];
		$C_leave=$_POST['C_leave_days'];
...
if( $LeaveType == 'Vacational Leave'){
	...
	$REMLEAVE1 = $V_leave - $num_days;
	$REMLEAVE2 = $C_leave;
}
elseif($LeaveType == 'Casual Leave'){
	$REMLEAVE = $av_leave - $num_days;
	$REMLEAVE2 = $C_leave - $num_days;
	$REMLEAVE1 = $V_leave;
	...
	$REMLEAVE2 = $C_leave;
		...
		elseif ($status === '1') {
				$result = mysqli_query($conn,"update tblleaves, tblemployees set tblleaves.registra_remarks='$description',tblleaves.admin_status='$status',tblleaves.AdminRemarkDate='$admremarkdate',tblemployees.V_leave_days='$REMLEAVE1',tblemployees.C_leave_days='$REMLEAVE2', tblemployees.Av_leave='$REMLEAVE' where tblleaves.empid = tblemployees.emp_id AND tblleaves.id='$did'");
			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post" action="">
						...
						$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.emp_id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.EmailId,tblemployees.V_leave_days,tblemployees.C_leave_days,tblemployees.Av_leave,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.AdminRemark,tblleaves.admin_status,tblleaves.registra_remarks,tblleaves.AdminRemarkDate,tblleaves.num_days from tblleaves join tblemployees on tblleaves.empid=tblemployees.emp_id where tblleaves.id=:lid";
						$query = $dbh -> prepare($sql);
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input  name="leaveType"type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly value="<?php echo htmlentities($result->LeaveType);?>">
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Avarage No. of Days</b></label>
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Available No. of  Vacational Days</b></label>
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly name="V_leave_days" value="<?php echo htmlentities($result->V_leave_days);?>">
								</div>
							</div>

							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label style="font-size:16px;"><b>Available No. of Casual Days</b></label>
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly name="C_leave_days" value="<?php echo htmlentities($result->C_leave_days);?>">
								</div>
							</div>							
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly value="From  <?php echo htmlentities($result->ToDate);?> to <?php echo htmlentities($result->FromDate);?>">
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label style="font-size:16px;"><b>Admin/Registry Status</b></label>
							...
							<?php 
							if(($stats==1 AND $ad_stats==1) OR ($stats==2 AND $ad_stats==2) OR ($stats==0 AND $ad_stats==0))
							  {
									...
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											<div class="modal-body text-center font-18">
												<h4 class="mb-20">Leave Approval Form</h4>
												...
												<div class="form-group">
													<label></label>
													<textarea id="textarea1" name="description" class="form-control" required placeholder="Comments" length="300" maxlength="300"></textarea>
												</div>
											</div>
											<div class="modal-footer justify-content-center">
