 ...
 if(isset($_POST['edit']))
{
    ...
    $result = mysqli_query($conn,"update tblleavetype set LeaveType='$leavetype',No_of_days='$No_of_days',date_to='$date_to',date_from='$date_from', Description='$description' where id = '$get_id' ");
    if ($result) {
									...
									<table class="data-table table stripe hover nowrap">
										...
										<tbody>
											...
											<tr>
	                                            ...
	                                            <?php echo htmlentities($result->date_from." - ".$result->date_to);?>
												<td>
