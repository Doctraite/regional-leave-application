<div class="left-side-bar">
		<div class="brand-logo">
			<a href="admin_dashboard.php">
				<img src="../vendors/images/MoH-square.png" alt="" class="dark-logo">
				<img src="../vendors/images/MoH-square.png" alt="" class="light-logo">
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<a href="summary.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-edit-1"></span><span class="mtext">Summary Report</span>
						</a>
					</li>
					<li>
						<a href="activity.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-logout"></span><span class="mtext">Staff Activity Login</span>
						</a>
					</li>
				</ul>
			</div>
