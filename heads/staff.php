					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								 ...
								 <?php
		                         $teacher_query = mysqli_query($conn,"select * from tblemployees where tblemployees.role = 'Staff' and tblemployees.Designation = '$session_depart' ORDER BY tblemployees.emp_id") or die(mysqli_error());
