...
if(isset($_POST['new_update']))
{
    ...
    $result = mysqli_query($conn,"update tblemployees set FirstName='$fname', LastName='$lname', EmailId='$email', Gender='$gender', Dob='$dob', Designation='$designation', Address='$address', Phonenumber='$phonenumber' where emp_id='$session_id'         
				...
				<div class="row">
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<p class="text-center text-muted font-14"><?php echo $row['Designation']; ?></p>
										...
										<div class="tab-pane fade show active" id="timeline" role="tabpanel">
											<div class="pd-20">
												<div class="profile-timeline">
													<?php $query= mysqli_query($conn,"SELECT * from tblleaves where empid = '$session_id'")or die(mysqli_error($conn));
													...
													<div class="profile-edit-list row">
														...
														<div class="weight-500 col-md-6">
															<div class="form-group">
																...
																<input name="department" class="form-control form-control-lg" type="text" placeholder="" required="true" autocomplete="off" value="<?php echo $row['Designation']; ?>">
															</div>
														 </div>
														<div class="weight-500 col-md-6">
															<?php
