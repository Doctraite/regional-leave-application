		...
		<div class="pd-ltr-20">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between">
							...
							<div class="table-actions">
								<a title="VIEW" href="staff_profile.php"><i class="icon-copy ion-disc" data-color="#17a2b8"></i></a>	
							</div>
						</div>
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between">
							<div class="h5 mb-0">data Setup</div>
							<div class="table-actions">
								<a title="VIEW" href="staff_profile.php"><i class="icon-copy ion-disc" data-color="#17a2b8"></i></a>	
							</div>
						</div>
						...
						<?php
						$query= mysqli_query($conn,"select LeaveType, No_of_Days from tblleavetype where LeaveType like '%Vacational Leave%'")or die(mysqli_error($conn));
						$row = mysqli_fetch_array($query);
						while ($row = mysqli_fetch_array($query)) {
 							  $data[] = $row['No_of_Days'];
