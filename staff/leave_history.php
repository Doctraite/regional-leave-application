			...
			<div class="row pb-10">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=1;
						 $query = mysqli_query($conn,"select * from tblleaves where empid = '$session_id' AND admin_status = '$status'")or die(mysqli_error($conn));
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=0;
						 $query_pend = mysqli_query($conn,"select * from tblleaves where empid = '$session_id' AND admin_status = '$status'")or die(mysqli_error($conn));
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=2;
						 $query_reject = mysqli_query($conn,"select * from tblleaves where empid = '$session_id' AND admin_status = '$status'")or die(mysqli_error($conn));
